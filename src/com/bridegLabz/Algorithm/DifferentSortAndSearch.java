							...
							do
							{
								...
								switch(ch1)
								{
									case 1: System.out.println("Enter the size of integers to sort:");
											...
											start=UtilClass.startTime();
											UtilClass.genericsBubbleSort(a1);
											end=UtilClass.endTime();
											for(Integer k:a1)
											{
												System.out.print(k+" ");
											}	
											System.out.println();
											System.out.println("Elapse time is : "+UtilClass.elapseTime(start,end)+" nano seonds"); 
											break; 
																			
									case 2: System.out.println("Enter String to sort:");
											String str=UtilClass.readStringArray();
											String[] s1=str.split(" ");
											start=UtilClass.startTime();
											String[] s2=UtilClass.genericsBubbleSort(s1);
											end=UtilClass.endTime();
											for(String s:s2)
											{
												System.out.print(s+" ");
											...
											System.out.println();
											System.out.println("Elapse time is : "+UtilClass.elapseTime(start,end)+" nano seconds");
											break;  
									}
							...
							do
							{
								...
								switch(ch3)
								{
									case 1: System.out.println("Enter the size of integer array:");
											...
											int key=sc.nextInt();
											start=UtilClass.startTime();
											int res=UtilClass.genericBinarySearch(a1, key);
											end=UtilClass.endTime();
											if(res>0)
									...
									case 2: System.out.println("Enter String to sort:");
											...
											String key1=UtilClass.readStringArray();
											start=UtilClass.startTime();
											int res1=UtilClass.genericBinarySearch(s1, key1);
											end=UtilClass.endTime();
											if(res1>0)
